...
class ClientsInfo:
    # Inicializar DataFrames vacíos o con archivos .csv
    # Necesita una contraseña inicial para crear el primer progreso o reglas, o para agregar más al mismo cliente
    def __init__(self, client_password: str) -> None:
        ...
        # Inicializar DataFrames vacíos por si no existen los archivos (contraseña, cita, peso, medidas, calorias | contra, tipo dieta, meta)
        ...
        # Si existen los archivos, cargan los datos en los DataFrames
    ...
    # Agregar un progreso con datos de entrada y con la contraseña ingresada
    ...
    # Verifica si existe al menos un registro con esa contraseña
    def get_client_exist(self):
        return (self.clients_rules["password"] == self.client_password).any()